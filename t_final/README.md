...
| `i2c_driver.sdc` | Constraints de síntese (clock 100 MHz, delays, false path do reset) |
| `synthesis.tcl` | Script de síntese lógica (Synopsys Design Compiler) |
| `12 - Trabalho Final - Driver I2C.pdf` | Especificação do trabalho |
